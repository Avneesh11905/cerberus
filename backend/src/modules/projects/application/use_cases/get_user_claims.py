...
class GetUserClaimsUseCase[SessionType](BaseProjectUseCase[SessionType]):
    ...
    async def execute(self, session: SessionType, project_id, tenant_id, user_id) -> dict:
        ...
        return {"default_claims": defaults, "user_overrides": overrides, "effective_claims": effective}
