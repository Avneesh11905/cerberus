...
from src.modules.auth.authentication.domain.entities import UserIdentity, ActiveSession
from src.modules.auth.authentication.infrastructure.models import RefreshToken
    ...
    async def validate(
        ...
        if refresh.user_id:
            ...
            user_identity = UserIdentity(
                ...
                email=tenant.email,
                name=tenant.name,
                picture=cast(AnyHttpUrl, tenant.picture) if tenant.picture else None,
