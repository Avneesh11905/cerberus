...
async def _execute_forgot_password_in_background(
    ...
    try:
        async with SQLAlchemyUnitOfWork() as uow:
            await usecase.execute(uow, email, project_id=project_id, frontend_url=frontend_url)
...
async def forgot_password(
    ...
    **Returns:**
    ...
    background_tasks.add_task(_execute_forgot_password_in_background, usecase, body.email, project_id, frontend_url)
