...
from src.modules.projects.application.use_cases.create_project import CreateProjectUseCase
from src.modules.projects.application.commands.project_commands import CreateProjectCommand
...
@pytest.mark.asyncio
async def test_create_project(uow_mock, api_key_adapter_mock, rsa_key_adapter_mock, analytics_mock):
