              ...
              <div className="space-y-6">
                <DialogHeader>
                  <DialogTitle className="text-2xl font-black text-slate flex items-center gap-2">
                    Project Created:{' '}
                    <span className="text-sage">{createdCredentials.name}</span>
                  </DialogTitle>
                  <DialogDescription className="text-terracotta font-bold flex items-start gap-2 mt-2 bg-terracotta/10 p-3 border-2 border-terracotta rounded-xl">
                    ...
                    Please copy it or download the JSON file now. If you lose
                    it, you will need to rotate the key.
                  </DialogDescription>
                </DialogHeader>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center p-12 border-2 border-dashed border-taupe bg-sand text-center">
          ...
          <p className="text-slate/70 mb-6 font-semibold max-w-sm">
            Create your first project to start authenticating users and managing
            environments.
          </p>
        ...
        <DialogContent className="sm:max-w-md border-terracotta">
          <DialogHeader>
            ...
            <DialogDescription className="mt-2">
              ...
              ? This action cannot be undone and will permanently destroy the
