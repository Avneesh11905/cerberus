...
function LandingPage() {
  ...
  useEffect(() => {
    ...
    mm.add('(min-width: 768px)', () => {
      ...
      heroTl
        .to('.hero-text-content', { opacity: 0, y: -50, duration: 1 }, 0)
        .to(
          '.hero-3d-graphic',
          {
            scale: 1.5,
      ...
      featuresTl
        .from('.feature-header', { y: 30, opacity: 0, duration: 0.5 })
        .from(
      ...
      codeTl
        ...
        .from(
          '.code-snippet-section .code-dot',
          { scale: 0, opacity: 0, stagger: 0.1, duration: 0.3 },
          '-=0.2',
        )
      ...
      intTl
        .to(
          '.integration-section .marquee-top',
          { x: () => -window.innerWidth, duration: 1 },
          0,
        )
        .to(
          '.integration-section .marquee-bottom',
          { x: () => window.innerWidth, duration: 1 },
          0,
        )
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 xl:gap-8 items-center w-full">
            <div className="hero-text-content z-10 w-full">
              ...
              >
                ...
                >
                  Stop rebuilding the same auth and analytics infrastructure for
                  every project. Cerberus provides drop-in multi-tenant
                  management, invisible bot protection, and real-time streaming
                  analytics in one beautiful, unbreakable platform.
                </motion.p>
          ...
          <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 py-16 sm:py-20 md:py-0">
            <div className="feature-header text-center mb-16">
              ...
              <p className="text-slate/70 font-medium max-w-2xl mx-auto text-lg leading-relaxed">
                A comprehensive toolkit engineered to secure your application
                and scale your business, wrapped in a developer-first
                experience.
              </p>
            </div>
          ...
          <div className="bottom-cta-wrapper w-full px-2 sm:px-0">
            <div className="flat-card-dark p-6 sm:p-12 rounded-2xl flex flex-col items-center">
              ...
              <p className="text-vanilla/80 font-medium max-w-xl mb-8 sm:mb-10 text-base sm:text-lg leading-relaxed">
                Join the next generation of developers building scalable,
                secure, and beautiful SaaS applications without the
...
function Hero3DGraphic() {
  ...
  useEffect(() => {
    ...
    floatAnim.to(
      '.hero-float-1',
      { y: '-=25', duration: 3, ease: 'sine.inOut' },
      0,
    )
    floatAnim.to(
      '.hero-float-2',
    ...
    floatAnim.to(
      '.hero-float-3',
      { y: '-=15', duration: 3.5, ease: 'sine.inOut' },
      0,
    )
    ...
    >
      ...
      <div className="hero-float-1 absolute transform rotate-12 translate-x-12 -translate-y-12 origin-center z-10">
        <div className="hero-parallax-1 w-56 h-48 bg-sand rounded-xl border-2 border-taupe p-4 flex flex-col shadow-[8px_8px_0px_0px_var(--slate)] overflow-hidden">
          <div className="w-8 h-8 rounded bg-slate mb-4 flex items-center justify-center text-vanilla shrink-0">
            <Users size={16} />
          </div>
      ...
      <div className="hero-float-3 absolute transform rotate-2 translate-x-2 translate-y-12 origin-center z-30">
        <div className="hero-parallax-3 w-64 h-48 bg-slate text-vanilla rounded-xl border-2 border-slate p-5 flex flex-col shadow-[8px_8px_0px_0px_var(--taupe)] overflow-hidden">
          <div className="w-8 h-8 rounded bg-vanilla text-slate mb-3 flex items-center justify-center shrink-0">
            <ShieldCheck size={16} />
          </div>
          <h4 className="font-bold text-lg mb-2 font-display tracking-tight shrink-0">
            Access Granted
          </h4>
          <div className="w-full h-6 bg-vanilla/20 rounded mb-3 border border-vanilla/30 shrink-0" />
          <div className="w-full h-8 bg-vanilla rounded mt-auto flex items-center justify-center text-slate font-bold text-xs shrink-0">
            Authorize
          </div>
        </div>
      </div>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <div className="code-text flex flex-col items-center lg:items-start text-center lg:text-left">
          ...
          <h2 className="text-3xl sm:text-5xl font-display font-bold tracking-tight mb-6">
            Integration takes minutes. <br className="hidden sm:block" /> Not
            sprints.
          </h2>
          <p className="text-vanilla/80 text-lg leading-relaxed mb-8 max-w-xl">
            Cerberus handles the heavy lifting of security, session management,
            and analytics so you can focus on building your actual product. Drop
            in our React components or hit the REST API directly.
          </p>
        ...
        <div className="code-window w-full h-100 bg-vanilla rounded-xl border-4 border-taupe flat-shadow overflow-hidden flex flex-col">
          ...
          <div className="w-full h-12 bg-sand border-b-4 border-taupe flex items-center px-4 gap-2 shrink-0">
            ...
            <div className="ml-4 text-xs font-bold text-slate/50 font-mono">
              App.tsx
            </div>
          </div>
          {/* Code Body */}
          <div className="p-4 sm:p-6 font-mono text-xs sm:text-sm md:text-base leading-loose text-slate overflow-auto flex-1 whitespace-nowrap">
            <div className="code-line text-sage">
              import {'{ CerberusProvider, useAuth }'} from{' '}
              <span className="text-terracotta">'cerberus-react'</span>
            </div>
            <br className="code-line" />
            <div className="code-line text-slate">
              function <span className="text-ochre">App</span>() {'{'}
            </div>
            <div className="code-line pl-4">return (</div>
            <div className="code-line pl-8 text-sage">
              {'<CerberusProvider '}
            </div>
            <div className="code-line pl-12 text-slate">
              clientId=
            ...
            <div className="code-line pl-12 text-slate">
              requireTurnstile=<span className="text-ochre">{'{true}'}</span>
            </div>
    ...
    <section className="integration-section w-full bg-sand py-16 sm:py-24 md:py-0 md:min-h-[calc(100vh-64px)] flex flex-col justify-center border-y-2 border-taupe/30 relative overflow-hidden">
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 mb-16">
        <div className="flex flex-col items-center text-center z-10 relative">
          <h2 className="text-3xl sm:text-5xl font-display font-bold text-slate tracking-tight mb-6">
            Plays nice with your stack.
          </h2>
          <p className="text-slate/70 font-medium max-w-2xl text-lg sm:text-xl">
            Whether you're building a modern SPA, a server-rendered app, or a
            native mobile client, Cerberus is completely framework-agnostic.
          </p>
        </div>
      </div>
