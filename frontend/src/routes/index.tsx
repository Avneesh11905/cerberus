...
console.log(\`Welcome back, \${user.email}\`)`
  ...
  return (
    <div className="h-screen w-full overflow-y-auto custom-scrollbar" onScroll={handleScroll}>
      ...
      {/* Background Effects */}
      <div className="fixed inset-0 bg-[linear-gradient(to_right,#cbd5e1_1px,transparent_1px),linear-gradient(to_bottom,#cbd5e1_1px,transparent_1px)] dark:bg-[linear-gradient(to_right,#ffffff0a_1px,transparent_1px),linear-gradient(to_bottom,#ffffff0a_1px,transparent_1px)] bg-size-[32px_32px] pointer-events-none mask-image-gradient" style={{ WebkitMaskImage: 'radial-gradient(ellipse 80% 50% at 50% 0%, #000 70%, transparent 100%)' }} />
      ...
      {/* Navigation */}
      <nav className={`fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 lg:px-12 py-4 w-full transition-all duration-300 bg-transparent border-b border-transparent ${isScrolled ? '-translate-y-full opacity-0 pointer-events-none' : 'translate-y-0 opacity-100'}`}>
          <div className="flex items-center gap-3 select-none cursor-default">
            <img src="/logo.webp" alt="Cerberus" className="w-10 h-10 md:w-12 md:h-12 select-none" draggable={false} />
            <span className="text-xl md:text-2xl tracking-tight text-slate-900 dark:text-white" style={{ fontFamily: 'Audiowide, sans-serif' }}>Cerberus</span>
          </div>
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            {isLoading ? (
              ...
              <div className="flex items-center gap-3">
                <Link to="/auth/login" className="text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white transition-colors">Sign In</Link>
                <Link to="/auth/register" className="hidden sm:inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-primary hover:bg-primary/90 rounded-full transition-all hover:scale-105 active:scale-95 shadow-lg shadow-primary/25">
                  Get Started
                </Link>
              </div>
            )}
      ...
      <main className="relative z-10 flex flex-col items-center">
        ...
        <section className="w-full px-6 pt-32 pb-20 md:pt-40 md:pb-32 mx-auto max-w-7xl text-center">
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-8 opacity-0-init animate-fade-in-up animate-delay-100 leading-[1.1]" style={{ fontFamily: 'Audiowide, sans-serif' }}>
          ...
          <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed opacity-0-init animate-fade-in-up animate-delay-200">
            A comprehensive multi-project platform to oversee your authentication. Effortlessly create projects, configure identity providers, manage access keys, and monitor user sessions.
          </p>
          ...
          <div className="grid lg:grid-cols-2 gap-8 md:gap-16 items-center">
            <div className="text-left space-y-6">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed">
                Cerberus SDK handles the heavy lifting. Token rotation, secure cookies, and API retries happen silently in the background, leaving your codebase clean and focused on your product.
              </p>
              <div className="flex gap-8 pt-4">
                <div className="flex flex-col gap-1">
                  <span className="text-4xl font-bold text-indigo-500 tracking-tighter">3x</span>
                  <span className="text-xs font-semibold text-slate-500 uppercase tracking-widest">Faster Setup</span>
                </div>
                <div className="w-px h-14 bg-slate-200 dark:bg-slate-800 self-center" />
                <div className="flex flex-col gap-1">
                  <span className="text-4xl font-bold text-indigo-500 tracking-tighter">0</span>
                  <span className="text-xs font-semibold text-slate-500 uppercase tracking-widest">Security Leaks</span>
                </div>
              </div>
            </div>
            ...
            <div className="relative group">
              ...
              <CodeBlock code={showcaseCode} language="typescript" title="auth.ts" className="my-0 relative z-10" hideCopy unselectable />
            </div>
          </div>
        </section>

        {/* Bento Box Features Section */}
        <section id="features" className="w-full py-24 border-t border-slate-200 dark:border-white/5 relative">
          ...
          <div className="max-w-6xl mx-auto px-6 relative z-10">
            <div className="text-center mb-16 md:mb-24">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
                Cerberus provides everything you need to ship a robust, advanced authentication system in minutes, not months.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[250px] md:auto-rows-[300px]">
              ...
              <div className="md:col-span-2 group relative p-8 md:p-10 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0f0f0f] hover:bg-slate-50 dark:hover:bg-[#151515] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                ...
                <div className="relative z-10 h-full flex flex-col justify-between">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Multi-Project Architecture</h3>
                    <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-base max-w-lg">
                      Build B2B SaaS platforms effortlessly. Cerberus allows you to isolate user pools into completely independent Projects, each with their own isolated security policies and origin controls.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="group relative p-8 md:p-10 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0f0f0f] hover:bg-slate-50 dark:hover:bg-[#151515] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                <div className="relative z-10 h-full flex flex-col justify-between">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Edge-Optimized</h3>
                    <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm">
                      Tokens are signed with secure public/private key cryptography, allowing instant verification at the edge without database latency.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="group relative p-8 md:p-10 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0f0f0f] hover:bg-slate-50 dark:hover:bg-[#151515] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                <div className="relative z-10 h-full flex flex-col justify-between">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">Native OAuth flows</h3>
                    <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm">
                      Easily add Google, GitHub, or Apple sign-ins. We handle the OAuth handshakes, callbacks, and automatic account merging for you.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="md:col-span-2 group relative p-8 md:p-10 rounded-[2.5rem] border border-slate-200 dark:border-slate-800 bg-white dark:bg-[#0f0f0f] hover:bg-slate-50 dark:hover:bg-[#151515] hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                ...
                <div className="relative z-10 h-full flex flex-col justify-between">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-3">Ironclad Token Security</h3>
                    <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-base max-w-lg">
                      We natively enforce HttpOnly and secure cookies. Our background rotators handle refresh tokens silently, completely eliminating race conditions and token theft risks.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="w-full relative pt-24 pb-32 border-t border-slate-200 dark:border-white/5 bg-slate-50 dark:bg-[#0a0a0a]">
          <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-8 leading-tight">
              Ready to <span className="text-transparent bg-clip-text bg-linear-to-r from-indigo-600 to-purple-600">secure</span> your next big idea?
            </h2>
            <p className="text-xl text-slate-600 dark:text-slate-400 mb-12 max-w-2xl mx-auto">
              Join developers building the next generation of web applications with Cerberus Authentication.
            </p>
      ...
      <footer className="w-full py-8 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-[#050505]">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <img src="/logo.webp" alt="Cerberus" className="w-6 h-6 select-none opacity-80" draggable={false} />
            <span className="text-sm font-semibold text-slate-700 dark:text-slate-300">Cerberus</span>
          </div>
