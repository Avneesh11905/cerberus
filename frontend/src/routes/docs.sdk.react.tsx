        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          <section id="protecting-routes" className="scroll-mt-8 mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
              Because Cerberus handles token refreshes silently in the
              background, you can protect frontend routes using a standard Auth
              Context.
            </p>
            ...
            <p className="text-slate-600 dark:text-slate-400 text-base mb-4">
              When your app mounts, try to fetch the current user profile. If it
              succeeds, they are logged in. If it throws a 401 error, they
              aren't.
            </p>
            <CodeBlock
              language="typescript"
...
export const useAuth = () => useContext(AuthContext);`}
            ...
            <h3
              id="protecting-private"
              className="text-2xl font-semibold mt-8 mb-3 scroll-mt-8"
            >
              2. Wrap Private Routes (Protected)
            </h3>
            <p className="text-slate-600 dark:text-slate-400 text-base mb-4">
              Use the context to block unauthorized access to private routes
              like a Dashboard. If the user isn't logged in, they are redirected
              to the login page.
            </p>
            <CodeBlock
              language="typescript"
...
export function ProtectedRoute({ children }) {
  ...
  return children;
            ...
            <h3
              ...
              className="text-2xl font-semibold mt-8 mb-3 scroll-mt-8"
            >
              3. Wrap Guest Routes (Logged Out Only)
            </h3>
            <p className="text-slate-600 dark:text-slate-400 text-base mb-4">
              For pages like <strong>Login</strong> or <strong>Register</strong>
              , you don't want logged-in users to access them. Use a Guest Route
              to redirect them to the dashboard if they are already
              authenticated.
            </p>
            <CodeBlock
              language="typescript"
...
export function GuestRoute({ children }) {
  ...
  return children;
            ...
            <h3
              ...
              className="text-2xl font-semibold mt-8 mb-3 scroll-mt-8"
            >
              4. Unprotected (Public) Routes
            </h3>
            <p className="text-slate-600 dark:text-slate-400 text-base mb-4">
              For public landing pages or documentation, simply don't wrap the
              route in either component. The user will be able to view the page
              regardless of their authentication state.
            </p>
            ...
            <div className="mt-8 p-5 bg-slate-50 dark:bg-[#1c1c1c] border border-blue-200 dark:border-blue-800/50 rounded-xl">
              <h4 className="text-sm font-semibold text-blue-800 dark:text-blue-300 mb-2">
                Troubleshooting: Session constantly drops or getMe() fails?
              </h4>
              <p className="text-sm text-slate-600 dark:text-slate-400 mb-3">
                If the code above always returns <code>401 Unauthorized</code>{' '}
                even after successfully calling{' '}
                <code>cerberus.auth.login()</code>, the browser is actively
                blocking the secure <code>HttpOnly</code> cookies.
              </p>
              <ul className="list-disc pl-5 space-y-1 text-sm text-slate-600 dark:text-slate-400">
                <li>
                  <strong>Check Dashboard Origins:</strong> Ensure your exact
                  frontend URL (e.g., <code>http://localhost:3000</code>) is
                  added to your project's <strong>Allowed Origins</strong> in
                  the Cerberus Global Dashboard. If the origin doesn't match,
                  cookies will not be set.
                </li>
                <li>
                  <strong>Check Browser Settings:</strong> If you are testing
                  across completely different domains without HTTPS, your
                  browser might block cross-site tracking cookies. Use HTTPS or
                  ensure localhost environments run without strict tracking
                  protection enabled.
                </li>
              </ul>
            </div>
