        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          <section id="getting-started" className="scroll-mt-8 mb-16">
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-6">
              Cerberus SDK Reference
            </h1>
            <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
              The official JavaScript/TypeScript Frontend SDK for the Cerberus
              Identity Platform. Seamlessly integrate Cerberus Authentication
              into any frontend application (React, Vue, Next.js, Svelte,
              Vanilla JS).
            </p>
            <div className="p-4 bg-slate-50 dark:bg-[#1c1c1c] border border-blue-200 dark:border-blue-800/50 rounded-xl text-sm text-blue-800 dark:text-blue-300">
              <strong>Looking for the backend?</strong> This is the frontend
              SDK. The core backend Auth-as-a-Service engine and the Global
              Dashboard can be found in the main repository:{' '}
              <a
                href="https://github.com/Avneesh11905/cerberus"
                target="_blank"
                className="font-semibold underline"
              >
                Avneesh11905/cerberus
              </a>
              .
            </div>
            ...
            <ul className="space-y-2 text-slate-600 dark:text-slate-400 mb-8">
              <li>
                <strong>Silent Token Refresh:</strong> Automatically intercepts{' '}
                <code>401 Unauthorized</code> responses, refreshes the Access
                Token, and transparently retries requests.
              </li>
              <li>
                <strong>Cross-Origin Security:</strong> Pre-configured with{' '}
                <code>withCredentials: true</code> for secure cross-origin
                cookies.
              </li>
              <li>
                <strong>Tenant Scoping:</strong> Automatically injects your{' '}
                <code>X-Cerberus-API-Key</code> into every request.
              </li>
              <li>
                <strong>End-to-End Type Safety:</strong> Fully typed requests
                and responses mirroring backend schemas.
              </li>
            </ul>
          </section>
          ...
          <section id="installation" className="scroll-mt-8 mb-16">
            ...
            <p className="text-base text-slate-600 dark:text-slate-400 mb-4">
              You can install this SDK directly from the GitHub repository using
              npm, yarn, or pnpm.
            </p>
            <CodeBlock
              language="bash"
            ...
            <p className="text-sm text-slate-500 italic mt-4">
              (The package contains a prepare script that automatically compiles
              the TypeScript code upon installation).
            </p>
          </section>
          ...
          <section id="initialization" className="scroll-mt-8 mb-16">
            ...
            <p className="text-base text-slate-600 dark:text-slate-400 mb-4">
              Initialize the SDK once in your application and export it. Provide
              your backend API URL and the Tenant API Key generated from your
              Cerberus Dashboard.
            </p>
            <CodeBlock
              language="typescript"
