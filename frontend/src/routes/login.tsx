...
function LoginPage() {
  ...
  const [pendingAction, setPendingAction] = useState<'login' | 'google' | 'github' | null>(null)
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link to="/forgot-password" className="text-sm text-slate font-bold hover:underline">
              Forgot password?
            </Link>
          </div>
