      ...
      <div className="max-w-none">
        ...
        <div className="mb-12">
          <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-slate-900 dark:text-white mb-6 leading-tight">
            Stop building auth from{' '}
            <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-600 to-indigo-500">
              scratch.
            </span>
          </h1>
          <p className="text-lg text-slate-600 dark:text-slate-400 leading-relaxed max-w-3xl">
            Building authentication involves managing secure cookies, CORS
            policies, token rotation, database sessions, and OAuth. With
            Cerberus, our powerful backend handles the complex security,
            allowing you to authenticate users with just a few lines of code.
          </p>
        </div>
            ...
            <div className="p-8 sm:p-10 bg-slate-50 dark:bg-slate-900/20 border-b md:border-b-0 md:border-r border-slate-200 dark:border-slate-800">
              ...
              <ul className="space-y-6 text-base text-slate-600 dark:text-slate-400">
                <li className="flex gap-4">
                  ...
                  <p>
                    Manually configuring strict CORS, HttpOnly, Secure, and
                ...
                <li className="flex gap-4">
                  <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-2 shrink-0" />
                  <p>
                    Implementing refresh token rotation securely without race
                    conditions.
                  </p>
                </li>
                <li className="flex gap-4">
                  <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-2 shrink-0" />
                  <p>
                    Building complex database structures to track active
                    sessions, IPs, and devices.
                  </p>
                </li>
                <li className="flex gap-4">
                  <div className="w-1.5 h-1.5 rounded-full bg-red-400 mt-2 shrink-0" />
                  <p>
                    Handling OAuth redirects, exchanging codes, and merging
                    duplicate accounts.
                  </p>
                </li>
              </ul>
            ...
            <div className="p-8 sm:p-10 bg-blue-50/30 dark:bg-blue-900/10">
              ...
              <ul className="space-y-6 text-base text-slate-700 dark:text-slate-300">
                <li className="flex gap-4">
                  ...
                  <p>
                    <strong>Natively secure cookies</strong> and strict CORS
                    across all your origins automatically.
                  </p>
                </li>
                <li className="flex gap-4">
                  <div className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 shrink-0" />
                  <p>
                    <strong>Silent interceptors</strong> that automatically
                    refresh tokens and retry failed requests.
                  </p>
                </li>
                <li className="flex gap-4">
                  <div className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 shrink-0" />
                  <p>
                    <strong>Real-time session tracking</strong> with instant
                    global revocation capabilities.
                  </p>
                </li>
                <li className="flex gap-4">
                  <div className="w-1.5 h-1.5 rounded-full bg-blue-500 mt-2 shrink-0" />
                  <p>
                    <strong>Native OAuth flows</strong> where the SDK handles
                    all redirects and callbacks for you.
                  </p>
                </li>
              </ul>
            </div>
        ...
        <div className="mt-20 mb-12">
          <div className="text-center mb-10">
            ...
            <p className="text-base text-slate-600 dark:text-slate-400">
              Powerful features packed into a developer-friendly API.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            <Card className="bg-slate-50 dark:bg-[#111] border-slate-200 dark:border-slate-800 rounded-2xl hover:bg-slate-100 dark:hover:bg-[#151515] transition-colors py-1 gap-2 shadow-none">
              ...
              <CardContent className="px-5 pt-0">
                <CardDescription className="text-slate-600 dark:text-slate-400">
                  Drop in the SDK, configure your Dashboard, and have secure
                  auth running in under 5 minutes.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-50 dark:bg-[#111] border-slate-200 dark:border-slate-800 rounded-2xl hover:bg-slate-100 dark:hover:bg-[#151515] transition-colors py-1 gap-2 shadow-none">
              ...
              <CardContent className="px-5 pt-0">
                <CardDescription className="text-slate-600 dark:text-slate-400">
                  Strict CORS policies, HttpOnly secure cookies, and automated
                  token rotation keep your users safe.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-50 dark:bg-[#111] border-slate-200 dark:border-slate-800 rounded-2xl hover:bg-slate-100 dark:hover:bg-[#151515] transition-colors py-1 gap-2 shadow-none">
              ...
              <CardContent className="px-5 pt-0">
                <CardDescription className="text-slate-600 dark:text-slate-400">
                  Support for traditional Email/Password as well as seamless
                  Google and GitHub OAuth logins.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-50 dark:bg-[#111] border-slate-200 dark:border-slate-800 rounded-2xl hover:bg-slate-100 dark:hover:bg-[#151515] transition-colors py-1 gap-2 shadow-none">
              ...
              <CardContent className="px-5 pt-0">
                <CardDescription className="text-slate-600 dark:text-slate-400">
                  A beautiful, centralized control panel to manage all your
                  projects, origins, and identity providers.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-50 dark:bg-[#111] border-slate-200 dark:border-slate-800 rounded-2xl hover:bg-slate-100 dark:hover:bg-[#151515] transition-colors py-1 gap-2 shadow-none">
              ...
              <CardContent className="px-5 pt-0">
                <CardDescription className="text-slate-600 dark:text-slate-400">
                  A completely type-safe TypeScript SDK that provides incredible
                  autocomplete and developer experience.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-slate-50 dark:bg-[#111] border-slate-200 dark:border-slate-800 rounded-2xl hover:bg-slate-100 dark:hover:bg-[#151515] transition-colors py-1 gap-2 shadow-none">
              ...
              <CardContent className="px-5 pt-0">
                <CardDescription className="text-slate-600 dark:text-slate-400">
                  Built on a highly scalable, multi-project backend architecture
