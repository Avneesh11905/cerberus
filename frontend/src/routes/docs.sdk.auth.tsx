        ...
        <div className="prose prose-slate dark:prose-invert max-w-none">
          <section id="auth-methods" className="scroll-mt-8 mb-16">
            ...
            <p className="text-lg text-slate-600 dark:text-slate-400 mb-8 leading-relaxed">
              The <code>cerberus.auth</code> module handles the entire lifecycle
              of user sessions.
            </p>
            ...
            <p className="text-slate-600 dark:text-slate-400 text-base mb-4">
              Registration is a two-step process to ensure email ownership.
            </p>
...
await cerberus.auth.resendVerification({ email: 'test@example.com' });`}
            ...
            <ApiRef
              ...
              args={[
                ...
                },
                {
                  name: 'data.password',
                  type: 'string',
                  desc: 'A strong password (min 8 chars).',
                },
                {
                  name: 'data.name',
                  type: 'string?',
            ...
            <ApiRef
              ...
              args={[
                ...
                },
                {
                  name: 'data.otp',
                  type: 'string',
                  desc: 'The 6-digit OTP received via email.',
                },
              ]}
              ret="Promise<MessageResponse>"
            />
            ...
            <p className="text-slate-600 dark:text-slate-400 text-base mb-4">
              Logging in automatically sets the secure HttpOnly refresh cookie
              in the user's browser. The SDK intercepts the response and stores
              the short-lived JWT in memory for subsequent requests.
            </p>
              ...
              args={[
                {
                  ...
                  type: 'string',
                  desc: 'The registered email address.',
                },
                {
              ...
              args={[
                {
                  name: 'provider',
                  type: 'string',
                  desc: "The OAuth provider name (e.g. 'google', 'github').",
                },
              ]}
              ret="Promise<void>"
            />
              ...
              args={[
                {
                  name: 'email',
                  type: 'string',
                  desc: 'The email address of the account.',
                },
              ]}
              ret="Promise<MessageResponse>"
            />
              ...
              args={[
                {
                  name: 'token',
                  type: 'string',
                  desc: 'The token received in the reset email.',
                },
                {
                  name: 'new_password',
                  type: 'string',
                  desc: 'The new secure password.',
                },
              ]}
              ret="Promise<MessageResponse>"
            />
              ...
              args={[
                {
                  ...
                  type: 'string?',
                  desc: "The user's current password. Optional if they authenticated via OAuth.",
                },
                {
              ...
              args={[
                {
                  name: 'familyId',
                  type: 'string',
                  desc: 'The UUID of the session family to revoke.',
                },
              ]}
              ret="Promise<void>"
            />
