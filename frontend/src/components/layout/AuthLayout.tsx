...
export function AuthLayout({
  ...
  return (
    <div className="min-h-screen bg-vanilla flex items-center justify-center p-4">
      ...
      >
        <div className="flat-card p-6 sm:p-8 rounded-xl flex flex-col relative">
          ...
          <div>
            ...
            <div className="mb-6 sm:mb-8 text-center">
              <h1 className="text-2xl sm:text-3xl font-display font-bold text-slate mb-2 tracking-tight">
                {title}
              </h1>
              {subtitle && (
                <p className="text-slate/70 text-sm font-medium">{subtitle}</p>
              )}
            </div>
            {children}
          </div>
