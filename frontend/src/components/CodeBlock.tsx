...
export function CodeBlock({
  ...
  return (
    <div
      className={`not-prose relative group rounded-2xl overflow-hidden border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-[#1c1c1c] shadow-lg ${className}`}
    >
      ...
      <div
        className={`p-5 overflow-x-auto text-sm md:text-base font-medium leading-relaxed bg-slate-50 dark:bg-[#1c1c1c] text-slate-900 dark:text-slate-50 custom-scrollbar ${unselectable ? 'select-none' : ''}`}
