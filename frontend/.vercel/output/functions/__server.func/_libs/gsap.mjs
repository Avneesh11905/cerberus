...
var distribute = function distribute(v) {
	...
	if (_isString$2(from)) ratioX = ratioY = {
		center: .5,
		edges: .5,
		end: 1
	}[from] || 0;
...
var Animation = /*#__PURE__*/ function() {
	...
	_proto.then = function then(onFulfilled) {
		...
		return new Promise(function(resolve) {
			var f = _isFunction$2(onFulfilled) ? onFulfilled : _passThrough$1, _resolve = function _resolve() {
				var _then = self.then;
				self.then = null;
				prevProm && prevProm();
...
var Timeline = /*#__PURE__*/ function(_Animation) {
	...
	_proto2.add = function add(child, position) {
		...
		if (!(child instanceof Animation)) {
			...
			if (_isString$2(child)) return this.addLabel(child, position);
			if (_isFunction$2(child)) child = Tween.delayedCall(0, child);
			else return this;
		}
	...
	_proto2.remove = function remove(child) {
		if (_isString$2(child)) return this.removeLabel(child);
		if (_isFunction$2(child)) return this.killTweensOf(child);
...
var _processVars = function _processVars(vars, index, target, targets, tween) {
	...
	if (!_isObject$1(vars) || vars.style && vars.nodeType || _isArray(vars) || _isTypedArray(vars)) return _isString$2(vars) ? _parseFuncOrString(vars, tween, index, target, targets) : vars;
	var copy = {}, p;
...
var _gsap = {
	...
	quickTo: function quickTo(target, property, vars) {
		var _setDefaults2;
		var tween = gsap$3.to(target, _setDefaults$1((_setDefaults2 = {}, _setDefaults2[property] = "+=0.1", _setDefaults2.paused = true, _setDefaults2.stagger = 0, _setDefaults2), vars || {})), func = function func(value, start, startIsRelative) {
...
var _initCore$2 = function _initCore() {
...
var _addRotationalPropTween = function _addRotationalPropTween(plugin, target, property, startNum, endValue) {
	var cap = 360, isString = _isString$2(endValue), change = parseFloat(endValue) * (isString && ~endValue.indexOf("rad") ? _RAD2DEG : 1) - startNum, finalValue = startNum + change + "deg", direction, pt;
	if (isString) {
...
var ScrollTrigger$1 = /*#__PURE__*/ function() {
	...
	_proto.init = function init(vars, animation) {
		...
		vars = _setDefaults(_isString$1(vars) || _isNumber(vars) || vars.nodeType ? { trigger: vars } : vars, _defaults);
	...
	ScrollTrigger.scrollerProxy = function scrollerProxy(target, vars) {
		...
		if (vars) isViewport ? _proxies.unshift(_win, vars, _body$1, vars, _docEl$1, vars) : _proxies.unshift(t, vars);
	};
...
//#endregion
export { gsapWithCSS as i, ScrollTrigger$1 as n, Observer as r, ScrollToPlugin as t };
